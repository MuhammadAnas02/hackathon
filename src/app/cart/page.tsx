...
export default function Cart() {
  ...
  return (
    ...
    <div className="mx-auto 2xl:w-[1600px] bg-white mt-5 flex flex-col md:flex-row">
      {/* Left section with product details */}
      <div className="flex-1">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 px-16 bg-[#FFF9E5] mx-[20px] py-4 gap-x-8 text-sm sm:text-base">
          <p>Product</p>
          <p>Price</p>
          <p>Quantity</p>
          <p>Total</p>
        ...
        {cart.map((item) => (
          <div key={item.id} className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-6 px-5 mt-10 mx-[20px] sm:mx-[60px] py-4 gap-x-8">
      ...
      <div className="w-full md:w-[360px] bg-[#FFF9E5] ml-0 md:ml-5 mt-2 md:mt-0 py-6">
        ...
        <Link href={'/checkout'}>
          <button
            className="border-2 border-black mt-9 mx-5 w-full sm:w-[236px] h-[58px] rounded-2xl text-lg"
          >
            Checkout
          </button>
        </Link>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-x-5 bg-secondary py-16 mx-auto my-20 2xl:w-[1600px] text-center">
      <div>
